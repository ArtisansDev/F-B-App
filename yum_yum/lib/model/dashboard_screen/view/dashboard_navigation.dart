...
class DashboardNavigationScreen extends StatelessWidget {
          ...
          children: [
            Expanded(
                child: bottomBarRowView(controller.selectedIndex.value, 0,
                    ImageAssetsConstants.iconMenu1, sHome.tr,imageAssets: ImageAssetsConstants.appLogo)),
            Expanded(
  ...
  bottomBarRowView(int selectValue, int position, String image, String title,{String? imageAssets}) {
    return GestureDetector(
        ...
        child: Column(
          ...
          children: [
            imageAssets!=null?
            imageSet(imageAssets, 23.sp, 23.sp,
