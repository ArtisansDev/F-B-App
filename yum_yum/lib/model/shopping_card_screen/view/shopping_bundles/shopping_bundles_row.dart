...
class ShoppingBundlesRow extends StatelessWidget {
  final int index;
  late ShoppingScreenController controller;

  ShoppingBundlesRow({super.key, required this.index}) {
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: getTextRegular(
                          size: 14.sp,
                          colors:
                          ColorConstants.cAppColors.shade800),
                    ),
                  ),
                  Container(
                    height: 4.32.h,
