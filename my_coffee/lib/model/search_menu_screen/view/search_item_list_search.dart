...
class SearchItemListSearch extends StatelessWidget {
  late SearchMenuScreenController controller;

  SearchItemListSearch({super.key}) {
    controller = Get.find<SearchMenuScreenController>();
  }
          ...
          children: [
            ...
            Expanded(
              ...
              placeHolder: AppConstants.iAccessKey == 1
                  ? sSearchforYUMItems.tr
                  : sSearchforTWTItems.tr,
              onSubmitted: (value) {
