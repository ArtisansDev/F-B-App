    ...
    return Obx(
      () => Visibility(
          visible: controller.mAddCartModel.value.sType != 'Dine' &&
              !kIsWeb &&
              (controller.selectGetAllBranchesListData.value.packagingData ??
                      [])
                  .isNotEmpty,
          child: Column(
            children: [
              ...
              Container(
                  margin:
                      EdgeInsets.only(left: 19.sp, right: 19.sp, top: 17.sp),
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: (controller.selectGetAllBranchesListData.value
                                .packagingData ??
                            [])
                        .length,
                    itemBuilder: (context, index) {
                      PackagingData mPackagingData = (controller
                              .selectGetAllBranchesListData
                              .value
                              .packagingData ??
                          [])[index];
                      return GestureDetector(onTap: () {
                        controller.packagingDataSelect(mPackagingData);
                      }, child: Obx(() {
                        return Container(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  //   width: 5.h,
                                  //   child: setImage(
                                  //       ImageAssetsConstants.needStraws),
                                  // ),
                                  // SizedBox(
                                  //   width: 13.sp,
                                  // ),
                                  Expanded(
                                      child: Text(
                                    mPackagingData.packagingName ?? '',
                                    style: getText500(
                                        size: 16.sp,
                                        colors: ColorConstants.buttonBar),
                                  )),
                                  controller.mSelectPackagingData.value == null
                                      ? Icon(
                                          Icons.check_box_outline_blank_rounded,
                                          color: Colors.grey.shade300,
                                        )
                                      : (controller.mSelectPackagingData.value
                                                  ?.packagingIDP
                                                  .toString() !=
                                              mPackagingData.packagingIDP
                                                  .toString())
                                          ? Icon(
                                              Icons
