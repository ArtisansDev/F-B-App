...
class OrderListHistoryView extends StatelessWidget {
  late ViewOrderHistoryController controller;

  OrderListHistoryView({super.key}) {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child:  Text(
                                  'x ${(mGetItemDetailsData.count ?? 0)}',
                                  style: getText500(colors: ColorConstants.buttonBar, size: 17.5.sp),
                                ),
