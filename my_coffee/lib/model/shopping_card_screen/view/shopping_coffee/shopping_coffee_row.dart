...
class ShoppingCoffeeRow extends StatelessWidget {
  final int index;
  late ShoppingScreenController controller;

  ShoppingCoffeeRow({super.key, required this.index}) {
  ...
  _fullRowView() {
    return getCardView(
        mColor: ColorConstants.cAppColors.shade50.withOpacity(0.5),
        Container(
          height: 36.h,
