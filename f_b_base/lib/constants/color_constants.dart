...
class ColorConstants {
  ...
  ///app Colour
  static const Color cAppColorsBlue = Color(0xFFF27337);

  static const int _cAppColorsBlueValue = 0xFFF27337;
  ...
  static const Color yourKeySkillsColor3 = Color(0xFFFFA91C);
